...
import { MapPin, Mail, Lock, User, ArrowRight, CheckCircle2 } from "lucide-react";
    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            Free account with the complete NIE checklist. Upgrade to unlock the
            full DNV process and expiry tracking.
          </p>

          <div className="space-y-3">
            {[
              "Full NIE checklist — free forever",
              "First 5 DNV steps — free with account",
